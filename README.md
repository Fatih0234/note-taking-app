...
<p align="left">
Hey there 👋 In this project, You can sign up to a note taking website and login into your account. Website checks the requirements of the website, password, name etc. 
Then you login to the website. You can take notes, and website will remember your notes when you relogin via its database structure. You can delete and add notes. 

My mostly ultimate aim was to get to know the Flask framework. In the future, I will be here for better products. See you then. 
